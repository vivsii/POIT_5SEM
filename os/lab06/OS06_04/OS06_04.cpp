...
int main()
{
	...
	processes[0] = createProcess(L"C:\\уник\\os\\lab06\\x64\\Debug\\OS06_04A.exe").hProcess;
	processes[1] = createProcess(L"C:\\уник\\os\\lab06\\x64\\Debug\\OS06_04B.exe").hProcess;
