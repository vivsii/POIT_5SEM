...
int main()
{
	...
	processes[0] = createProcess(L"C:\\уник\\os\\lab06\\x64\\Debug\\OS06_03A.exe").hProcess;
	processes[1] = createProcess(L"C:\\уник\\os\\lab06\\x64\\Debug\\OS06_03B.exe").hProcess;
