...
int main()
{
	...
	processes[0] = createProcess(L"C:\\уник\\os\\lab06\\x64\\Debug\\OS06_05A.exe").hProcess;
	processes[1] = createProcess(L"C:\\уник\\os\\lab06\\x64\\Debug\\OS06_05B.exe").hProcess;
